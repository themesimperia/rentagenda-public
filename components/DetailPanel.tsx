...
export function DetailPanel({
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-sm">
      ...
      <PhotoGallery photos={listing.photos} title={listing.title} variant="panel" />
          ...
          <div className="min-w-0">
            {permalink ? (
              <Link href={permalink} className="block">
                <h2 className="text-xl font-bold leading-tight text-slate-900 hover:text-blue-600">
                  {listing.title}
                </h2>
              </Link>
            ) : (
              <h2 className="text-xl font-bold leading-tight text-slate-900">{listing.title}</h2>
            )}
            ...
            <dl className="grid grid-cols-2 gap-y-2 text-sm">
              ...
              {listing.bedrooms != null && (
                <>
                  ...
                  <dd className="text-right font-medium text-slate-700">{listing.bedrooms}</dd>
                </>
              )}
              {listing.bathrooms != null && (
                <>
                  <dt className="text-slate-400">Bathrooms</dt>
                  <dd className="text-right font-medium text-slate-700">{listing.bathrooms}</dd>
                </>
              )}
            </dl>
          </div>
